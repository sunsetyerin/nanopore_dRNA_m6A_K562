...
rule minimap2_index:
    ...
    output:
        idx=data_dir / "reference2/transcriptome_reference.mmi",
        # dx=data_dir / "reference/transcriptome_reference.mmi",
    log:
        logs_dir / "minimap2_index2.log",
...
rule minimap2_align:
    ...
    output:
        ...
        bam_index=aln_dir / "{sample}.bam.bai",
    log:
        # logs_dir / "minimap2_align/{sample}.log",
        logs_dir / "minimap2_align2/{sample}.log",
    threads: 100
    resources:
